  ...
  var e = function (n) {
    ...
    c = function (n, t) {
      return function (e, r) {
        const o = n[t];
        return void 0 !== r
          ? e in o && o[e].handlers.some((n) => n.namespace === r)
          : e in o;
      };
    },
    s = function (n, t, e = !1) {
      return function (r, ...o) {
        ...
        if (!c || !c.length) return e ? o[0] : void 0;
        ...
        for (i.__current.push(s); s.currentIndex < c.length; ) {
          ...
          e && (o[0] = n), s.currentIndex++;
        }
        return i.__current.pop(), e ? o[0] : void 0;
      };
    },
    u = function (n, t) {
      return function () {
        var e;
        const r = n[t];
        return null !== (e = r.__current[r.__current.length - 1]?.name) &&
          void 0 !== e
          ? e
          : null;
      };
    ...
    l = function (n, t) {
      return function (e) {
        ...
        return void 0 === e
          ...
          : !!r.__current[0] && e === r.__current[0].name;
      };
    },
    a = function (n, t) {
      return function (e) {
        const o = n[t];
        if (r(e)) return o[e] && o[e].runs ? o[e].runs : 0;
      };
    };
  class d {
    constructor() {
